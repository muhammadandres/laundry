      ...
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-100">
        <div>
          <h2 className="text-lg font-bold text-slate-900">
            Input Transaksi Bon Baru
          </h2>
          <p className="text-xs text-slate-500 mt-0.5">
            Masukkan detail transaksi laundry secara akurat
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            required
            className={`${inputClass} w-full min-w-0 max-w-full block box-border appearance-none`}
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              inputMode="numeric"
              name="total_bon"
              value={form.total_bon}
              onChange={handleTotalChange}
              required
              className={`${inputClass} pl-10 font-bold text-slate-900`}
              placeholder="0"
            />
          </div>
        </div>
